...
hi Conceal guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi Cursor guibg=#eeaabe ctermbg=217 gui=NONE cterm=NONE
hi CursorIM guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
...
hi FoldColumn guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi SignColumn guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
...
hi ModeMsg guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi MoreMsg guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
...
hi PmenuSbar guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi PmenuThumb guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi Question guifg=#25b7b8 ctermfg=10 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Search guifg=NONE ctermfg=NONE guibg=#e2d1d1 ctermbg=252 gui=underline cterm=underline
hi SpecialKey guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi SpellBad guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi SpellLocal guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi SpellCap guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi SpellRare guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi StatusLine guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi StatusLineNC guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
...
hi VisualNOS guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi WarningMsg guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
hi WildMenu guifg=#ff0000 ctermfg=9 guibg=#25b7b8 ctermbg=10 gui=NONE cterm=NONE
